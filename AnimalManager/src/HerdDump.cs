...
{
    /// <summary>
    /// Diagnostic helper. Dumps an animal's full WatchedAttributes tree so we can confirm the
    /// exact husbandry attribute keys against a live game (see the ".herddump" command). This
    /// is how the "VERIFY" keys in <see cref="AnimalStatReader"/> get pinned down without
    /// decompiling.
    /// </summary>
